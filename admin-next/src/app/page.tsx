...
export default function AdminPage() {
  ...
  return (
    <div className="min-h-screen bg-[#07090E] text-white flex flex-col md:flex-row selection:bg-purple-500 selection:text-white">
      {/* Sidebar */}
      <aside className="w-full md:w-80 bg-[#0B0F19] border-r border-[#1E2638] flex flex-col justify-between shrink-0 max-h-screen overflow-y-auto scrollbar-thin">
        <div>
          {/* Logo */}
          <div className="p-5 border-b border-[#1E2638] flex items-center gap-3 sticky top-0 bg-[#0B0F19] z-20">
      ...
      <main className="flex-1 overflow-y-auto">
        ...
        <header className="bg-[#0B0F19]/80 backdrop-blur-xl border-b border-[#1E2638] px-6 py-4 flex flex-col md:flex-row items-center justify-between gap-4 sticky top-0 z-30">
          <div>
