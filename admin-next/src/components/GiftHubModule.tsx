...
const STATIC_CATALOG: Gift[] = [
  ...
  { id: 'GIFT-AUTUMN-WINDMILL',      name: 'Autumn Windmill',       icon: '🍂', costCoins: 1200, rewardDiamonds: 840,  category: 'Popular',         animationType: 'AUTUMN_WINDMILL_SVGA',     svgaUrl: 'https://aura-live-voice-chat-1.onrender.com/uploads/svga/Autumn_Windmill_.svga', xpReward: 600,  isLucky: false, multiplierMax: 500, active: true, createdAt: '' },
  { id: 'GIFT-BLUE-ENCHANTRESS',     name: 'Blue Enchantress',      icon: '💙', costCoins: 600,  rewardDiamonds: 420,  category: 'Draw',            animationType: 'BLUE_ENCHANTRESS_SVGA',    svgaUrl: 'https://aura-live-voice-chat-1.onrender.com/uploads/svga/Blue_Enchantress.svga', xpReward: 300,  isLucky: false, multiplierMax: 500, active: true, createdAt: '' },
  { id: 'GIFT-CHILDHOOD-SWEETHEARTS',name: 'Childhood Sweethearts', icon: '👫', costCoins: 1500, rewardDiamonds: 1050, category: 'Popular',         animationType: 'CHILDHOOD_SWEETHEARTS_SVGA',svgaUrl: 'https://aura-live-voice-chat-1.onrender.com/uploads/svga/Childhood_sweethearts__1_.svga', xpReward: 750, isLucky: false, multiplierMax: 500, active: true, createdAt: '' },
  { id: 'GIFT-CROWNING-LOVE',        name: 'Crowning Love',         icon: '👑', costCoins: 3500, rewardDiamonds: 2450, category: 'VIP',             animationType: 'CROWNING_LOVE_SVGA',       svgaUrl: 'https://aura-live-voice-chat-1.onrender.com/uploads/svga/Crowning_Love__2_.svga', xpReward: 1750, isLucky: false, multiplierMax: 500, active: true, createdAt: '' },
  { id: 'GIFT-FLOWER-BOAT',          name: 'Flower Boat',           icon: '⛵', costCoins: 800,  rewardDiamonds: 560,  category: 'Popular',         animationType: 'FLOWER_BOAT_SVGA',         svgaUrl: 'https://aura-live-voice-chat-1.onrender.com/uploads/svga/Flower_Boat__1_.svga', xpReward: 400,  isLucky: false, multiplierMax: 500, active: true, createdAt: '' },
  { id: 'GIFT-MERMAID-GIRL',         name: 'Mermaid Girl',          icon: '🧜‍♀️', costCoins: 2200, rewardDiamonds: 1540, category: 'Multi',           animationType: 'MERMAID_GIRL_SVGA',        svgaUrl: 'https://aura-live-voice-chat-1.onrender.com/uploads/svga/Mermaid_girl__1_.svga', xpReward: 1100, isLucky: false, multiplierMax: 500, active: true, createdAt: '' },
  { id: 'GIFT-RABBIT-HEARTBEAT',     name: 'Rabbit Heartbeat',      icon: '🐰', costCoins: 1000, rewardDiamonds: 700,  category: 'Family Prestige', animationType: 'RABBIT_HEARTBEAT_SVGA',    svgaUrl: 'https://aura-live-voice-chat-1.onrender.com/uploads/svga/Rabbit_Heartbeat__1_.svga', xpReward: 500, isLucky: false, multiplierMax: 500, active: true, createdAt: '' },
  { id: 'GIFT-RUNAWAY-SWEETHEART',   name: 'Runaway Sweetheart',    icon: '💖', costCoins: 1800, rewardDiamonds: 1260, category: 'Popular',         animationType: 'RUNAWAY_SWEETHEART_SVGA',  svgaUrl: 'https://aura-live-voice-chat-1.onrender.com/uploads/svga/Runaway_Sweetheart__1_.svga', xpReward: 900, isLucky: false, multiplierMax: 500, active: true, createdAt: '' },
  { id: 'GIFT-SECRET-CAGE',          name: 'Secret Cage',           icon: '🕊️', costCoins: 900,  rewardDiamonds: 630,  category: 'Draw',            animationType: 'SECRET_CAGE_SVGA',         svgaUrl: 'https://aura-live-voice-chat-1.onrender.com/uploads/svga/Secret_Cage__1_.svga', xpReward: 450,  isLucky: false, multiplierMax: 500, active: true, createdAt: '' },
  { id: 'GIFT-MAGIC-DEY',            name: 'Magic Lamp Dream',      icon: '🪔', costCoins: 750,  rewardDiamonds: 525,  category: 'Special FX',      animationType: 'MAGIC_DEY_SVGA',           svgaUrl: 'https://aura-live-voice-chat-1.onrender.com/uploads/svga/dey__1_.svga', xpReward: 375,  isLucky: false, multiplierMax: 500, active: true, createdAt: '' },
];
